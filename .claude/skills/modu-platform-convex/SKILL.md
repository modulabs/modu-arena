...
allowed-tools: Read Write Bash(npx:*) Bash(npm:*) Bash(node:*) Grep Glob mcp__context7__resolve-library-id mcp__context7__get-library-docs
...
metadata:
  ...
  related-skills: "modu-platform-supabase, modu-lang-typescript, modu-domain-frontend"
...
- modu-platform-supabase for alternative PostgreSQL-based backend
- modu-lang-typescript for TypeScript patterns and best practices
- modu-domain-frontend for React integration patterns
- modu-platform-clerk for Clerk authentication patterns
- modu-platform-auth0 for Auth0 authentication patterns
