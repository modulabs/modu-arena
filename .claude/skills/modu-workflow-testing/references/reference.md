# modu-workflow-testing Reference
...
from modu_workflow_testing import DevelopmentWorkflow, WorkflowConfig
...
from modu_workflow_testing import TDDManager, TestSpecification, TestType
...
from modu_workflow_testing import AIDebugger
...
from modu_workflow_testing import PerformanceProfiler
...
```bash
# CLI diagnostics
modu-workflow diagnose --full-check
modu-workflow test --dry-run --verbose
modu-workflow profile --list-available
modu-workflow review --show-rules

# Python diagnostics
from modu_workflow_testing import diagnose
...
- Workflow logs: `.modu/logs/workflow.log`
- Test results: `.modu/test-results/`
- Profile data: `.modu/profiles/`
- Review reports: `.modu/reviews/`
- Debug sessions: `.modu/debug-sessions/`
...
- modu-foundation-core - TRUST 5 framework and SPEC-First TDD
- modu-domain-backend - Backend development workflows
- modu-domain-frontend - Frontend development workflows
- modu-platform-baas - Backend-as-a-Service integration
