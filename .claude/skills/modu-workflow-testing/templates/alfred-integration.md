...
class AlfredAgentCoordinator:
 ...
 def __init__(self):
 self.debug_agent = "modu-essentials-debug"
 self.perf_agent = "modu-essentials-perf"
 self.review_agent = "modu-essentials-review"
 self.trust_agent = "modu-foundation-trust"
