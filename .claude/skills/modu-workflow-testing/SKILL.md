...
description: >
  ...
  or code refactoring (use modu-workflow-ddd instead).
license: Apache-2.0
...
- modu-domain-backend: Backend development workflows and API testing patterns
- modu-domain-frontend: Frontend development workflows and UI testing strategies
- modu-foundation-core: Core SPEC system and workflow management integration
- modu-platform-supabase: Supabase-specific testing patterns and database testing
- modu-platform-vercel: Vercel deployment testing and edge function validation
- modu-platform-firebase-auth: Firebase authentication testing patterns
- modu-workflow-project: Project management and documentation workflows
...
Maintained by: Modu-ADK Development Workflow Team
