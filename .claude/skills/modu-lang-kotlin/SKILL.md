...
metadata:
  ...
  related-skills: "modu-lang-java, modu-lang-swift"
...
- `modu-lang-java` - Java interoperability and Spring Boot patterns
- `modu-domain-backend` - REST API, GraphQL, microservices architecture
- `modu-domain-database` - JPA, Exposed, R2DBC patterns
- `modu-quality-testing` - JUnit 5, MockK, TestContainers integration
- `modu-infra-docker` - JVM container optimization
