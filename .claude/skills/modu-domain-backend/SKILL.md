...
description: >
  ...
  (use modu-domain-database instead) or frontend implementation
  (use modu-domain-frontend instead).
license: Apache-2.0
...
- modu-domain-frontend - Full-stack development integration
- modu-domain-database - Advanced database patterns
- modu-foundation-core - MCP server development patterns for backend services
- modu-quality-security - Security validation and compliance
- modu-foundation-core - Core architectural principles
...
Maintained by: Modu-ADK Backend Team
