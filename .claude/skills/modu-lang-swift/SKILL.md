...
metadata:
  ...
  related-skills: "modu-lang-kotlin, modu-lang-flutter"
...
- `modu-lang-kotlin` - Android counterpart for cross-platform projects
- `modu-lang-flutter` - Flutter/Dart for cross-platform mobile
- `modu-domain-backend` - API integration and backend communication
- `modu-foundation-quality` - iOS security best practices
- `modu-workflow-testing` - Xcode debugging and profiling
