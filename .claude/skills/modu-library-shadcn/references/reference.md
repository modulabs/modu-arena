...
- `modu-domain-frontend` (Frontend development patterns)
- `modu-baas-foundation` (Enterprise UI architecture)
- `modu-security-api` (UI security implementation)
- `modu-essentials-perf` (Performance optimization)
- `modu-foundation-trust` (Accessibility and compliance)
- `modu-domain-backend` (Backend integration)
- `modu-baas-vercel-ext` (Frontend deployment)
- `modu-domain-testing` (Component testing strategies)
