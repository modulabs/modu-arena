...
metadata:
  ...
  related-skills: "modu-platform-supabase, modu-lang-typescript, modu-domain-database"
...
# modu-platform-neon: Neon Serverless PostgreSQL Specialist
...
- modu-platform-supabase for alternative when RLS or pgvector needed
- modu-lang-typescript for TypeScript patterns for Drizzle and Prisma
- modu-domain-backend for backend architecture with database integration
- modu-domain-database for general database patterns and optimization
