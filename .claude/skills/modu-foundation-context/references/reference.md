# modu-foundation-context Reference
...
- `modu-foundation-claude`: Claude Code authoring and configuration
- `modu-foundation-core`: Core execution patterns and SPEC workflow
- `modu-workflow-project`: Project management and documentation
- `modu-cc-memory`: Memory management and persistence
