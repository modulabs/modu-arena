...
metadata:
  ...
  related-skills: "modu-lang-swift, modu-lang-kotlin"
...
- `modu-lang-swift` - iOS native integration for platform channels
- `modu-lang-kotlin` - Android native integration for platform channels
- `modu-domain-backend` - API integration and backend communication
- `modu-quality-security` - Mobile security best practices
- `modu-essentials-debug` - Flutter debugging and DevTools
