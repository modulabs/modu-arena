...
metadata:
  ...
  related-skills: "modu-domain-frontend, modu-docs-generation"
...
- modu-domain-frontend: React/Vue SVG component integration
- modu-docs-generation: SVG diagram generation for documentation
- modu-domain-uiux: Icon systems and design system integration
