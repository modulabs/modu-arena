...
- modu-domain-backend - Full-stack development
- modu-library-shadcn - Component library integration
- modu-domain-uiux - UI/UX design principles
- modu-lang-typescript - TypeScript patterns
- modu-workflow-testing - Frontend testing
