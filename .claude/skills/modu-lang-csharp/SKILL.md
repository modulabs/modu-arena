...
- `modu-domain-backend` - API design, database integration patterns
- `modu-platform-deploy` - Azure, Docker, Kubernetes deployment
- `modu-workflow-testing` - Testing strategies and patterns
- `modu-foundation-quality` - Code quality standards
- `modu-essentials-debug` - Debugging .NET applications
