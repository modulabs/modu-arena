...
metadata:
  ...
  related-skills: "modu-platform-railway, modu-lang-typescript, modu-domain-frontend"
...
# modu-platform-vercel: Vercel Edge Deployment Specialist
...
- modu-platform-railway for container-based deployment alternative
- modu-lang-typescript for TypeScript patterns for Next.js
- modu-domain-frontend for React and Next.js component patterns
- modu-foundation-quality for deployment validation and testing
- modu-domain-database for database patterns for Vercel Postgres
