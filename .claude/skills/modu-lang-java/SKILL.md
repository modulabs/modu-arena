...
metadata:
  ...
  related-skills: "modu-lang-kotlin, modu-domain-backend"
...
- modu-lang-kotlin for Kotlin interoperability and Spring Kotlin extensions
- modu-domain-backend for REST API, GraphQL, and microservices architecture
- modu-domain-database for JPA, Hibernate, and R2DBC patterns
- modu-foundation-quality for JUnit 5, Mockito, and TestContainers integration
- modu-infra-docker for JVM container optimization
