...
description: >
  ...
  (use modu-domain-frontend instead) or shadcn/ui specifics
  (use modu-library-shadcn instead).
license: Apache-2.0
...
- modu-lang-typescript - TypeScript and JavaScript best practices
- modu-foundation-core - TRUST 5 quality validation
- modu-library-nextra - Documentation generation
- modu-library-shadcn - shadcn/ui specialized patterns
