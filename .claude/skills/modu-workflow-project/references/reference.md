# modu-workflow-project Reference
...
- Initialization: `ModuMenuProject(project_path: str)`
- Primary Methods:
...
```python
# Integration with /modu:1-plan and /modu:3-sync
from modu_workflow_project import ModuMenuProject

# Initialize project system
project = ModuMenuProject("/path/to/project")

# After /modu:1-plan generates SPEC
...
def ci_documentation_check(project_path: str) -> dict:
    ...
    project = ModuMenuProject(project_path)
...
from modu_workflow_project import TemplateOptimizer
...
- Project logs: `.modu/logs/project.log`
- Template optimization logs: `.modu/logs/template-optimizer.log`
- Language initialization logs: `.modu/logs/language-init.log`
...
- Modu-ADK Documentation: https://github.com/modu-adk/docs
- Claude Code Skills Guide: https://docs.anthropic.com/claude-code/skills
- SPEC-First DDD Methodology: See `modu-foundation-core/modules/spec-first-ddd.md`

### Related Skills

- modu-foundation-core - Core execution patterns and SPEC workflow
- modu-foundation-claude - Claude Code integration patterns
- modu-workflow-docs - Unified documentation management
- modu-workflow-templates - Template optimization strategies
- modu-library-nextra - Advanced documentation architecture
