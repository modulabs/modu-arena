...
# Modu Workflow Project - Integrated Project Management System
...
- modu-foundation-core: Core execution patterns and SPEC-driven development workflows
- modu-foundation-claude: Claude Code integration and configuration
