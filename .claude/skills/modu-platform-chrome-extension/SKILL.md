---
name: modu-platform-chrome-extension
description: >
...
metadata:
  ...
  related-skills: "modu-lang-typescript, modu-lang-javascript, modu-domain-frontend"
...
- modu-lang-typescript for TypeScript patterns in extension development
- modu-lang-javascript for JavaScript patterns and ES module usage
- modu-domain-frontend for React or framework-based popup and side panel UI
- modu-domain-backend for server-side API integration
- modu-workflow-testing for extension testing strategies
...
Generated with: Modu-ADK Skill Factory v1.0
