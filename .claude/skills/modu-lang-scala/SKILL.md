...
- modu-lang-java - JVM interoperability, Spring Boot integration
- modu-domain-backend - REST API, GraphQL, microservices patterns
- modu-domain-database - Doobie, Slick, database patterns
- modu-workflow-testing - ScalaTest, MUnit, property-based testing
