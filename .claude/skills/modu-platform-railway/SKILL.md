...
allowed-tools: Read Write Bash(railway:*) Bash(npm:*) Bash(npx:*) Bash(docker:*) Grep Glob mcp__context7__resolve-library-id mcp__context7__get-library-docs
...
metadata:
  ...
  related-skills: "modu-platform-vercel, modu-domain-backend"
...
# modu-platform-railway: Container Deployment Specialist
...
- modu-platform-vercel for edge deployment for frontend
- modu-domain-backend for backend architecture patterns
- modu-lang-python for Python FastAPI deployment
- modu-lang-typescript for TypeScript Node.js patterns
- modu-lang-go for Go service deployment
