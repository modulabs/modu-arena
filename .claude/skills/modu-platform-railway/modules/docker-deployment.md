...
- modu-lang-python: Python deployment patterns
- modu-lang-typescript: TypeScript deployment patterns
- modu-lang-go: Go deployment patterns
- modu-lang-rust: Rust deployment patterns
