...
Reference Skill("modu-library-nextra") for comprehensive Nextra patterns.
...
Pattern for generating documentation from Modu SPEC files:
...
Skills:
- modu-library-nextra - Comprehensive Nextra documentation framework patterns
- modu-lang-python - Python docstring conventions and typing
- modu-lang-typescript - TypeScript/JSDoc documentation patterns
- modu-domain-backend - API documentation for backend services
- modu-workflow-project - Project documentation integration
