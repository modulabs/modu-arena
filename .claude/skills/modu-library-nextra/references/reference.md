...
- `modu-docs-generation`: Automated documentation generation
- `modu-workflow-docs`: Documentation workflow management
- `modu-domain-frontend`: Frontend development patterns
- `modu-library-mermaid`: Diagram integration
