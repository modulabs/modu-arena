...
Complementary skills include modu-docs-generation for auto-generating docs from code, modu-workflow-docs for validating documentation quality, and modu-cc-claude-md for Markdown formatting.
...
- modu-docs-generation for content generation
- modu-workflow-docs for documentation validation
- modu-library-mermaid for diagram integration

Commands:

- modu:3-sync for documentation deployment
- modu:0-project for Nextra project initialization
