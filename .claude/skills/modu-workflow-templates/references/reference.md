# modu-workflow-templates Reference
...
from modu_workflow_templates import TemplateManager
...
from modu_workflow_templates import TemplateOptimizer

optimizer = TemplateOptimizer("/project/.modu")
...
from modu_workflow_templates import FeedbackTemplateGenerator
...
from modu_workflow_templates import VersionManager
...
- Solution: Review conflicts in `.modu/merge-conflicts/` and resolve manually
...
from modu_workflow_templates import diagnose
...
- Template storage: `.claude/skills/modu-workflow-templates/templates/`
- Backups: `.modu/backups/templates/`
- Merge conflicts: `.modu/merge-conflicts/`
- Version history: `.modu/config/template-versions.json`
- Feedback templates: `.claude/skills/modu-workflow-templates/modules/feedback-templates.md`
...
- Modu-ADK Templates Guide: See `modules/code-templates.md`
- Feedback Templates Reference: See `modules/feedback-templates.md`
- Template Optimizer Guide: See `modules/template-optimizer.md`

### Related Skills

- modu-workflow-project - Project initialization with templates
- modu-foundation-core - SPEC-driven template generation
- modu-docs-generation - Documentation template scaffolding
- modu-cc-configuration - Claude Code settings integration
