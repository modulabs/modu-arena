...
description: >
  ...
  Do NOT use for SPEC document creation (use modu-workflow-spec instead)
...
metadata:
  ...
  aliases: "modu-workflow-templates"
  replaces: "modu-core-code-templates, modu-core-feedback-templates, modu-project-template-optimizer"
...
- Optimizing template structures after Modu-ADK updates
...
- modu-project-config-manager: Configuration management and validation
- modu-cc-configuration: Claude Code settings integration
- modu-foundation-specs: SPEC template generation
- modu-docs-generation: Documentation template scaffolding
- modu-core-workflow: Template-driven workflows
...
- v2.0.0 (2025-11-24): Unified modu-core-code-templates, modu-core-feedback-templates, and modu-project-template-optimizer into single skill with 5 core patterns
