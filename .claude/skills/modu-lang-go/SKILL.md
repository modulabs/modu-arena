...
metadata:
  ...
  related-skills: "modu-lang-rust, modu-domain-backend"
...
- modu-domain-backend for REST API architecture and microservices
- modu-lang-rust for systems programming companion
- modu-quality-security for security hardening
- modu-essentials-debug for performance profiling
- modu-workflow-ddd for domain-driven development
