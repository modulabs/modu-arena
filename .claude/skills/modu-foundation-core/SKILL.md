---
name: modu-foundation-core
description: >
  Provides Modu-ADK foundational principles including TRUST 5 quality framework,
  ...
  agent delegation patterns, or Modu orchestration rules.
  Do NOT use for context and token management (use modu-foundation-context instead)
  or strategic analysis (use modu-foundation-philosopher instead).
license: Apache-2.0
...
# Modu Foundation Core

Foundational principles and architectural patterns that power Modu-ADK's AI-driven development workflow.
...
Skills: modu-cc-claude-md for CLAUDE.md with foundation patterns, modu-cc-configuration for config with TRUST 5, modu-cc-memory for token optimization, modu-context7-integration for MCP integration.
