# modu-foundation-core Reference
...
from modu_foundation_core import TRUST5Validator
...
from modu_foundation_core import SPECManager, DDDExecutor, DocsGenerator
...
from modu_foundation_core import TaskAnalyzer, AgentRouter
...
from modu_foundation_core import TokenMonitor, ContextOptimizer
...
modu-trust check --all --verbose

# Token budget analysis
modu-context analyze --show-breakdown

# Agent routing debug
modu-agent route --task "description" --dry-run

# SPEC validation
modu-spec validate SPEC-001 --format EARS
```

### Validation Utilities

```python
from modu_foundation_core import diagnose
...
- TRUST 5 logs: `.modu/logs/trust5/`
- SPEC artifacts: `.modu-arena/specs/`
- Agent execution logs: `.modu/logs/agents/`
- Token usage history: `.modu/logs/tokens/`
...
- Modu-ADK Documentation: See project README
...
- modu-workflow-project - Project management with core principles
- modu-workflow-testing - Testing workflows with TRUST 5
- modu-workflow-templates - Template management integration
