...
decision = splitter.should_split(".claude/skills/modu-foundation-core/SKILL.md")
...
if decision["split_needed"]:
 ...
 ".claude/skills/modu-foundation-core",
...
# Usage
organizer = SkillOrganizer(".claude/skills/modu-foundation-core")
...
with open(".claude/skills/modu-foundation-core/NAVIGATION.md", 'w') as f:
 f.write(navigation)
```
...
# Usage
discovery = ModuleDiscovery(".claude/skills/modu-foundation-core")
...
Skills:
- modu-foundation-progressive-disclosure - Content structuring
- modu-cc-skill-factory - Skill creation with modular structure
- modu-foundation-token-optimization - File loading efficiency
...
- Skill("modu-foundation-core") modules/ - Memory files following modular pattern
