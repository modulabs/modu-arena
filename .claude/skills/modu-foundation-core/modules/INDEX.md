# Modu Foundation Core - Modules Directory

Purpose: Extended documentation modules for modu-foundation-core skill, providing deep dives into each foundational principle.
...
This directory contains 9 comprehensive modules covering Modu-ADK's foundational principles and execution rules:
...
Agent Catalog - Complete reference of Modu-ADK's 26 specialized agents with 7-tier hierarchy.
...
Command Catalog - Complete reference for Modu-ADK's 6 core commands in SPEC-First DDD workflow.
...
skill_path = Path(".claude/skills/modu-foundation-core")
...
class ModuleSearch:
 ...
 modules_dir = Path(".claude/skills/modu-foundation-core/modules")
 results = []
...
Skills:
- modu-foundation-core (parent skill)
- modu-cc-skill-factory (skill creation)
- modu-core-agent-factory (agent creation)
