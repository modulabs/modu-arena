...
Purpose: Security policies, execution constraints, and Git workflow strategies governing Modu-ADK agent behavior.
...
| `Skill()` | Knowledge invocation | `Skill("modu-foundation-core")` |
...
- Create documentation in `.modu/` directory
...
This comprehensive set of execution rules ensures that Modu-ADK operates securely, efficiently, and in compliance with industry standards while maintaining high quality output.
