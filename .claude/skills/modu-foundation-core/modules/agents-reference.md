# Agents Reference - Modu-ADK Agent Catalog

Purpose: Complete reference catalog of Modu-ADK's 26 specialized agents with `{domain}-{role}` naming convention and 7-tier hierarchy.
...
All Modu-ADK agents follow consistent naming:
...
Core command processors directly bound to Modu commands.
...
Meta-generation agents for Modu-ADK development.
...
Use Case: When developing Modu-ADK itself (not for end-user projects)
...
Note: These are Claude Code built-in agents, not Modu-ADK custom agents.
...
|----------|--------|---------|
| Language (Separated) | modu-lang-python, modu-lang-typescript, modu-lang-systems, modu-lang-jvm, modu-lang-mobile | Domain-specific language skills for 40-60% token savings |
| Platform (Separated) | modu-platform-auth, modu-platform-database, modu-platform-deploy | Domain-specific platform skills for 30-50% token savings |
| Foundation | modu-foundation-core, modu-foundation-claude, modu-foundation-context, modu-foundation-quality | Core principles and quality gates |
| Workflow | modu-workflow-spec, modu-workflow-project, modu-workflow-testing, modu-workflow-jit-docs | Workflow automation and testing |
| Domain | modu-domain-backend, modu-domain-frontend, modu-domain-database, modu-domain-uiux | Domain expertise patterns |

Language Skills Selection Guide:

| Language Skill | Coverage | Use When |
|----------------|----------|----------|
| modu-lang-python | Python 3.13, FastAPI, Django, pytest | Backend APIs, data science, automation |
| modu-lang-typescript | TypeScript 5.9, React 19, Next.js 16, tRPC | Frontend, full-stack web development |
| modu-lang-systems | Go 1.23, Rust 1.91, Fiber, Axum | Microservices, CLI tools, systems programming |
| modu-lang-jvm | Java 21, Kotlin 2.0, Scala 3.4, Spring | Enterprise applications, big data |
| modu-lang-mobile | Swift 6, Kotlin Android, Flutter 3.24 | iOS, Android, cross-platform mobile |

Platform Skills Selection Guide:

| Platform Skill | Providers | Use When |
|----------------|-----------|----------|
| modu-platform-auth | Auth0, Clerk, Firebase Auth | Authentication implementation |
| modu-platform-database | Supabase, Neon, Convex, Firestore | Database platform integration |
| modu-platform-deploy | Vercel, Railway | Deployment and CI/CD |

Note: Agents now use specific skills based on their domain. Cross-language agents include modu-lang-python and modu-lang-typescript by default.
...
Skills:
- [modu-foundation-core](../SKILL.md) - Parent skill (this module is part of it)
- [modu-foundation-context](../../modu-foundation-context/SKILL.md) - Token budget and session state
- [modu-foundation-claude](../../modu-foundation-claude/SKILL.md) - Claude Code configuration
