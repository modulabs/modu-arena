...
TRUST 5 is Modu-ADK's comprehensive quality assurance framework enforcing five pillars:
...
# Validate skill
result = validator.validate_skill(".claude/skills/modu-foundation-core")
...
if not result["valid"]:
 ...
 # Auto-split
 validator.auto_split_skill(".claude/skills/modu-foundation-core")
...
# Usage
loader = ProgressiveContentLoader(".claude/skills/modu-foundation-core")
...
Skills:
- modu-foundation-modular-system - File organization patterns
- modu-foundation-token-optimization - Content efficiency
- modu-cc-skill-factory - Skill creation with progressive structure
