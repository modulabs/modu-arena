...
- `modu-lang-rust` - Systems programming comparison and interop
- `modu-domain-backend` - Backend service architecture
- `modu-workflow-testing` - DDD and testing strategies
- `modu-essentials-debug` - Debugging and profiling
- `modu-foundation-quality` - TRUST 5 quality principles
