...
#### Running Scans
```bash
# Scan with Modu-ADK rules
sg scan --config .claude/skills/modu-tool-ast-grep/rules/sgconfig.yml
...
- **modu-workflow-testing** - DDD integration, test pattern detection
- **modu-foundation-quality** - TRUST 5 compliance, code quality gates
- **modu-domain-backend** - API pattern detection, security scanning
