...
metadata:
  ...
  related-skills: "modu-workflow-testing, modu-foundation-quality, modu-domain-backend, modu-domain-frontend"
  context: "fork"
  agent: "Explore"
...
AST-Grep is integrated into Modu-ADK through the Tool Registry as AST_ANALYZER type in tool_registry.py, PostToolUse Hook for automatic security scanning after Write/Edit operations, and Permissions with Bash(sg:*) and Bash(ast-grep:*) auto-allowed.

### Running Scans

To scan with Modu-ADK rules, execute sg scan with config pointing to .claude/skills/modu-tool-ast-grep/rules/sgconfig.yml.
...
- modu-workflow-testing: DDD integration and test pattern detection
- modu-foundation-quality: TRUST 5 compliance and code quality gates
- modu-domain-backend: API pattern detection and security scanning
- modu-domain-frontend: React/Vue pattern optimization
- modu-lang-python: Python-specific security and style rules
- modu-lang-typescript: TypeScript type safety patterns
