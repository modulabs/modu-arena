...
To invoke this skill, use the standard skill invocation pattern with the skill name modu-library-mermaid.
...
### Integration with Modu-ADK

This skill is designed for use within Claude Code during various development phases:

During the architecture phase with the modu:1-plan command, create system design diagrams to visualize proposed solutions and component relationships.

During the documentation phase with the modu:3-sync command, generate visual documentation including flowcharts, sequence diagrams, and architecture overviews.
...
Skills that complement this skill include modu-docs-generation for comprehensive documentation generation, modu-workflow-docs for diagram validation and documentation workflows, and modu-library-nextra for architecture documentation sites.

Commands that utilize this skill include modu:3-sync for documentation with embedded diagrams and modu:1-plan for SPEC creation with visual architecture diagrams.
