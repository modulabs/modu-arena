# modu-workflow-jit-docs Reference
...
- `.modu/docs/`: Project-specific documentation
...
- `modu-docs-generation`: Generate documentation
- `modu-workflow-docs`: Documentation workflows
- `modu-library-nextra`: Nextra documentation sites
- `modu-foundation-context`: Token budget management
