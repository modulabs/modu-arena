...
description: >
  ...
  Do NOT use for writing new tests (use modu-workflow-testing instead)
...
metadata:
  ...
  context: "fork"
  agent: "manager-ddd"
  related-skills: "modu-tool-ast-grep, modu-workflow-testing, modu-foundation-quality"
---
...
When executing DDD through modu:2-run in DDD mode:
...
Load modu-tool-ast-grep for detailed pattern syntax and rule creation.
