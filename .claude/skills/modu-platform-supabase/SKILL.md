...
metadata:
  ...
  related-skills: "modu-platform-neon, modu-lang-typescript"
...
# modu-platform-supabase: Supabase Platform Specialist
...
- modu-platform-neon for alternative PostgreSQL for specific use cases
- modu-lang-typescript for TypeScript patterns for Supabase client
- modu-domain-backend for backend architecture integration
- modu-foundation-quality for security and RLS best practices
- modu-workflow-testing for DDD testing with Supabase (characterization tests for legacy, specification tests for new features)
...
Generated with: Modu-ADK Skill Factory v2.0
