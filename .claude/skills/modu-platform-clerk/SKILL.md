...
metadata:
  ...
  related-skills: "modu-platform-auth0, modu-lang-typescript"
...
- modu-platform-auth0 for alternative enterprise SSO solution
- modu-platform-supabase for Supabase authentication integration
- modu-platform-vercel for Vercel deployment with Clerk
- modu-lang-typescript for TypeScript development patterns
- modu-domain-frontend for React and Next.js integration
