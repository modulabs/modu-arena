...
- **modu-platform-auth0**: Enterprise SSO alternative
- **modu-platform-firebase-auth**: Firebase authentication
- **modu-lang-typescript**: TypeScript development patterns
- **modu-domain-frontend**: React and Next.js integration
- **modu-platform-supabase**: Supabase authentication
- **modu-platform-vercel**: Vercel deployment
