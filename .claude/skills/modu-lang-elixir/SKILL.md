...
- `modu-domain-backend` - REST API and microservices architecture
- `modu-domain-database` - SQL patterns and query optimization
- `modu-workflow-testing` - DDD and testing strategies
- `modu-essentials-debug` - AI-powered debugging
- `modu-platform-deploy` - Deployment and infrastructure
