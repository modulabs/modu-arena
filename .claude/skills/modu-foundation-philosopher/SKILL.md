---
name: modu-foundation-philosopher
description: >
  ...
  Do NOT use for code quality validation (use modu-foundation-quality instead)
  or implementation workflows (use modu-workflow-ddd instead).
license: Apache-2.0
...
### Integration with Modu Workflow
...
Skills:
- modu-foundation-core: Integration with TRUST 5 and SPEC workflow
- modu-workflow-spec: Assumption documentation in SPEC format
- modu-domain-backend: Technology-specific trade-off criteria
- modu-domain-frontend: UI/UX decision frameworks
