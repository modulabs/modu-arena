...
metadata:
  ...
  related-skills: "modu-lang-typescript, modu-domain-frontend, modu-lang-javascript"
---
...
- modu-lang-typescript - TypeScript patterns for type-safe Electron development
- modu-domain-frontend - React, Vue, or Svelte renderer development
- modu-lang-javascript - Node.js patterns for main process
- modu-domain-backend - Backend API integration
- modu-workflow-testing - Testing strategies for desktop apps
