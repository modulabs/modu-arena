...
- modu-domain-backend - Backend data serialization and API responses
- modu-domain-database - Database data format optimization
- modu-foundation-core - MCP data serialization and transmission patterns
- modu-workflow-docs - Documentation data formatting
- modu-foundation-context - Context optimization for token budgets
...
Maintained by: Modu-ADK Data Team
