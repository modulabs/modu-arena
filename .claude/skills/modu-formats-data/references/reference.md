...
Initialization:
```python
from modu_formats_data import TOONEncoder
...
Initialization:
```python
from modu_formats_data import JSONOptimizer
...
Initialization:
```python
from modu_formats_data import DataValidator
...
```python
from modu_formats_data import YAMLOptimizer
...
```python
from modu_formats_data import StreamProcessor
...
```python
from modu_formats_data import TOONEncoder, DataValidator
...
from modu_formats_data import TOONEncoder, JSONOptimizer
...
```python
from modu_formats_data import JSONOptimizer, DataValidator
