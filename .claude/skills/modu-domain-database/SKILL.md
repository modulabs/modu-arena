...
description: >
  ...
  (use modu-domain-backend instead).
license: Apache-2.0
...
- modu-domain-backend - API integration and business logic
- modu-foundation-core - Database migration and schema management
- modu-workflow-project - Database project setup and configuration
- modu-platform-supabase - Supabase database integration patterns
- modu-platform-neon - Neon database integration patterns
- modu-platform-firestore - Firestore database integration patterns
...
Maintained by: Modu-ADK Database Team
