...
description: >
  ...
  Do NOT use for writing tests (use modu-workflow-testing instead)
...
metadata:
  ...
  aliases: "modu-foundation-quality"
...
- modu-foundation-core - TRUST 5 framework reference
- modu-workflow-ddd - DDD workflow validation
- modu-security-owasp - Security compliance
- modu-context7-integration - Context7 best practices
- modu-performance-optimization - Performance analysis
