...
LOG_FILE="$PROJECT_ROOT/.modu/logs/quality-gate.log"
CONFIG_FILE="$PROJECT_ROOT/.modu/config/quality-config.yaml"
...
# Default values
PROJECT_PATH="src/"
OUTPUT_DIR=".modu/reports/quality"
...
check_dependencies() {
    ...
    local python_deps=("modu-core-quality")
...
Options:
  ...
  --output-dir DIR          Output directory for reports (default: .modu/reports/quality)
