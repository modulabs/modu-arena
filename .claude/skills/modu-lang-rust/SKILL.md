...
- `modu-lang-go` - Go systems programming patterns
- `modu-domain-backend` - REST API architecture and microservices patterns
- `modu-foundation-quality` - Security hardening for Rust applications
- `modu-workflow-testing` - Test-driven development workflows
