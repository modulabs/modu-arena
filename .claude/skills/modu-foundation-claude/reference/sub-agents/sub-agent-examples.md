...
model: sonnet
skills: modu-domain-backend, modu-essentials-perf, modu-context7-integration, modu-lang-python
---
...
model: sonnet
skills: modu-domain-frontend, modu-cc-configuration, modu-context7-integration, modu-ui-ux-expert
---
...
model: haiku
skills: modu-code-quality, modu-cc-configuration, modu-lang-python
---
...
model: sonnet
skills: modu-essentials-debug, modu-core-code-reviewer, modu-context7-integration
---
...
model: sonnet
skills: modu-lang-python, modu-domain-testing, modu-foundation-quality, modu-core-spec-authoring
---
...
tools: Read, Write, Edit, Grep, Glob, Bash, WebFetch, mcp__context7__resolve-library-id, mcp__context7__get-library-docs
model: sonnet
skills: modu-domain-security, modu-cc-security, modu-foundation-quality, modu-core-workflow
---
