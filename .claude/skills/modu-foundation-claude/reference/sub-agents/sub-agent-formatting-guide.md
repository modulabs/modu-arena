...
skills: modu-lang-python, modu-domain-backend, modu-context7-integration

# Load quality and documentation skills
skills: modu-foundation-quality, modu-docs-generation, modu-cc-claude-code
```
...
model: sonnet
skills: modu-domain-backend, modu-essentials-perf, modu-context7-integration
---
...
model: haiku
skills: modu-code-quality, modu-cc-configuration
---
...
model: sonnet
skills: modu-lang-python, modu-domain-testing, modu-foundation-quality
---
...
model: sonnet
skills: modu-foundation-trust, modu-code-quality, modu-security-expert
---
...
model: sonnet
skills: modu-domain-backend, modu-domain-frontend, modu-domain-database, modu-devops-expert, modu-security-expert
---
