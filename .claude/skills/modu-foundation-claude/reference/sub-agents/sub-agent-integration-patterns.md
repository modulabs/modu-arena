...
model: sonnet
skills: modu-core-workflow, modu-project-manager, modu-foundation-quality
---
...
model: sonnet
skills: modu-domain-backend, modu-domain-frontend, modu-domain-database, modu-devops-expert
---
