...
Purpose: Generate project documentation from codebase analysis. Creates product.md, structure.md, and tech.md in .modu/project/ directory.
...
- Fresh Documentation: When .modu/project/ is empty, generate all three files
...
- Phase 0-2: Modu orchestrator (AskUserQuestion for all user interaction)
