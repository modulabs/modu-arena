...
- Marker types: `<modu>DONE</modu>`, `<modu>COMPLETE</modu>`, `<modu:done />`
...
- If session duration exceeds 25 minutes OR iteration time doubling:
  - Save proactive checkpoint to .modu/cache/ralph-snapshots/memory-pressure.json
...
- Save iteration snapshot to .modu/cache/ralph-snapshots/
...
Snapshot location: .modu/cache/ralph-snapshots/
...
Loop state file: .modu/cache/.modu_loop_state.json
