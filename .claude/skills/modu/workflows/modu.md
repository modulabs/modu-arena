# Workflow: Modu - Autonomous Development Orchestration

Purpose: Full autonomous workflow. User provides a goal, Modu autonomously executes plan -> run -> sync pipeline. This is the default workflow when no subcommand is specified.
...
- Conditionally update project documents (.modu/project/) when structural changes detected
