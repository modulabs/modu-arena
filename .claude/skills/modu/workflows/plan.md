...
- Implements Steps 1-2 of Modu's 4-step workflow (Intent Understanding, Plan Creation)
...
- .modu/project/product.md (product context)
- .modu/project/structure.md (architecture context)
- .modu/project/tech.md (technology context)
...
- Reports route to .modu/reports/, Documentation to .modu/docs/
