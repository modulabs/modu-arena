...
The manager-quality agent executes: gh issue create --repo modu-ai/modu-adk
...
- Description content
- Priority level
- Environment information (Modu version, OS)
...
- Phase 1 collects all user input at Modu orchestrator level
...
- Phase 1: Modu orchestrator (AskUserQuestion for feedback collection)
