...
- modu-domain-frontend for UI components and styling patterns
- modu-domain-backend for API design and database integration
- modu-library-shadcn for component library integration
- modu-workflow-testing for testing strategies and patterns
- modu-foundation-quality for code quality standards
- modu-essentials-debug for debugging TypeScript applications
