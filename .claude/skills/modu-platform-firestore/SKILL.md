...
metadata:
  ...
  related-skills: "modu-platform-firebase-auth, modu-lang-flutter, modu-lang-typescript"
...
# modu-platform-firestore: Firebase Firestore Specialist
...
- modu-platform-firebase-auth for Firebase Authentication integration
- modu-lang-flutter for Flutter SDK patterns
- modu-lang-typescript for TypeScript client patterns
- modu-domain-mobile for mobile architecture patterns
- modu-quality-security for Security Rules best practices
