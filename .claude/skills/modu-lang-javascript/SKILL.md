...
- modu-lang-typescript for TypeScript integration and type checking with JSDoc
- modu-domain-backend for API design and microservices architecture
- modu-domain-database for database integration and ORM patterns
- modu-workflow-testing for DDD workflows and testing strategies
- modu-foundation-quality for code quality standards
- modu-essentials-debug for debugging JavaScript applications
