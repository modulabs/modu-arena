...
- modu-domain-backend for REST API and microservices architecture
- modu-domain-database for SQL patterns and ORM optimization
- modu-workflow-testing for DDD and testing strategies
- modu-platform-deploy for Docker and deployment patterns
- modu-essentials-debug for AI-powered debugging
- modu-foundation-quality for TRUST 5 quality principles
