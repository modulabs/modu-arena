---
name: modu-platform-firebase-auth
description: >
...
metadata:
  ...
  related-skills: "modu-platform-firestore, modu-lang-flutter, modu-lang-typescript"
...
- modu-platform-firestore for Firestore database with auth-based security
- modu-lang-flutter for Flutter SDK for mobile Firebase Auth
- modu-lang-typescript for TypeScript patterns for Firebase SDK
- modu-domain-backend for backend architecture with Firebase Admin SDK
