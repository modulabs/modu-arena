# Modu-ADK Integration Module

Purpose: Detailed integration patterns for modu-worktree with Modu-ADK Plan-Run-Sync workflow including plan phase automation, DDD integration, and cleanup workflows.
...
- Default: {repo}/.modu/worktrees/{project-name}/SPEC-{id}
...
- Looks for .modu/worktrees directory in path hierarchy
...
### Modu Configuration Integration

Worktree settings in .modu/config/config.yaml:
...
- worktree_root: Base directory for worktrees (default: {repo}/.modu/worktrees)
...
Version: 1.0.0
Last Updated: 2026-01-06
Module: Modu-ADK workflow integration patterns for Plan-Run-Sync phases
