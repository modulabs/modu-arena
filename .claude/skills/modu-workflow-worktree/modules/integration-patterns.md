...
Purpose: Overview of integration patterns for modu-worktree with Modu-ADK workflow, development tools, and external systems.
...
Integration Points:
- Modu-ADK Workflow: Seamless integration with /modu:1-plan, /modu:2-run, /modu:3-sync
...
The basic integration workflow follows three phases. During the Plan Phase, the /modu:1-plan command auto-creates a worktree for the SPEC. During the Development Phase, use the modu-worktree go command to navigate to the isolated environment and run /modu:2-run for DDD implementation. During the Sync Phase, use modu-worktree sync to update the worktree and /modu:3-sync for documentation synchronization.
...
Modu-ADK Integration: Refer to modu-adk-integration.md
- Plan Phase integration with /modu:1-plan
- Development Phase integration with /modu:2-run
- Sync Phase integration with /modu:3-sync
...
### Modu-ADK Workflow Integration

The worktree system integrates deeply with the Modu Plan-Run-Sync workflow:
...
Detailed Reference: Refer to modu-adk-integration.md for complete workflow patterns
...
For automatic SPEC worktree creation, integrate with /modu:1-plan by configuring auto-creation in worktree settings. Refer to modu-adk-integration.md for implementation details.
...
For team collaboration with shared registries, configure team registry settings with developer-specific worktree prefixes. Refer to modu-adk-integration.md for coordination patterns.

---

## Sub-Module References

Modu-ADK Integration (modu-adk-integration.md):
- Complete /modu:1-plan integration patterns
- DDD-aware /modu:2-run integration
- Sync Phase automation with /modu:3-sync
