...
Purpose: Integration patterns for modu-worktree with development tools, IDEs, terminals, CI/CD pipelines, and monitoring systems.
...
- Run Tests: Execute /modu:2-run for the SPEC
- Sync Worktree: Run modu-worktree sync command
...
- Command option completion for all modu-worktree subcommands
...
Navigation Aliases:
- mw: Short alias for modu-worktree
- mwl: List worktrees
...
- mwdev: Switch to worktree and start development with /modu:2-run
