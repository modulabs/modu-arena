...
- **Read SPEC Directory Structure** [HARD]:
  - Each SPEC is a **folder** (e.g., `.modu-arena/specs/SPEC-001/`)
...
1. Locate the SPEC folder in `.modu-arena/specs/SPEC-{ID}/` directory
...
- For SPEC-001: Read `.modu-arena/specs/SPEC-001/spec.md`, `.modu-arena/specs/SPEC-001/plan.md`, `.modu-arena/specs/SPEC-001/acceptance.md`
...
- workflow-spec: Create SPEC file (`.modu-arena/specs/`)
...
This agent participates in the /modu:2-run Phase chain. Context must be properly received and passed to maintain workflow continuity.

**Input Context** (from /modu:2-run command):
