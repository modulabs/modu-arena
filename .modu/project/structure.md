# Modu Rank - Project Structure

## Monorepo Layout

Modu Rank uses a Turborepo monorepo with Bun as the package manager. The repository is organized into two workspaces: `apps/` for deployable applications and `packages/` for shared libraries.
